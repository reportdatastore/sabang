...
const reportsData = {
    daily: [
        ...
        { id: 'daily2', title: 'LOGBOOK', icon: 'fa-book', report.href: 'select_logbook.html', detail: 'LOGBOOK Harian: Catatan kejadian operasional, masalah, dan solusi dari tim restoran.' },
